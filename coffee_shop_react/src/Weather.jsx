...
export default function Weather({currentTemp, userCity}) {
    ...
    //(ex. of ternary same as the if/else statement) 
    //let currentImage = 
    //currentTemp && currentTemp > 80 ? hotCloudImage : 
    //currentTemp && currentTemp < 60 ? coldCloudImage : happyCloudImage;
    return (  
        <div className="weatherCloud" style={{paddingRight:'50px', paddingTop:'20px'}}>
